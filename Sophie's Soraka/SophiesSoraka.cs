...
namespace Sophies_Soraka
{
    ...
    internal class SophiesSoraka
    {
        ...
        public static void OnGameLoad(EventArgs args)
        {
            ...
            PrintChat("loaded.");
			PrintChat("Please delete Sophie's Soraka from the loader, and reinstall it from the assembly database. This version of Sophies Soraka will be removed soon. 9/4/15");
